...
const Promo = ({ page, showCurrentPage }) => {
  const promoHomeContent = (
    <>
      <Stripes lightness="light" blockClassPrefix="promo" />
      <h2 className="promo__subtitle subtitle">
        We makes every day full of energy and taste
      </h2>
      <h2 className="promo__subtitle subtitle">Want to try our beans?</h2>
      <HashLink className="promo__btn btn btn--white" to="/#about-us">
        More
      </HashLink>
    </>
  );
  ...
  return (
    <section className={"promo " + page}>
      <div className="container">
        <Navigation showCurrentPage={showCurrentPage} />
